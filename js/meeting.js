...
ws.onopen = () => {
  ...
  if (participantsList.children.length === 0) {
    isFirstToJoin = true;  // أول جهاز ينتظر فقط
    console.log("👤 I am the first to join. I will wait for offers.");
  } else {
    console.log("👤 I am joining after someone. I may initiate offers.");
  }
